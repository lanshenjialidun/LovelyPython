...
# script used to use Karrigell on the OVH web hosting
# put this script in folder cgi-bin of your OVH site
# and set its mode to execute
...
try:
    ...
    initFile = os.path.join(root,"www","karrigell","conf","Karrigell_Apache.ini")

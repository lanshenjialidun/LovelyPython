...
is set to 1
In this case, session information is stored in a PyDbLite database, 
indexed by the sessionId (a unique 8-characters string). In this case, only 
...
# a dictionary or a PyDbLite database according to the persistentSession option
if k_config.persistentSession:
    sessionFile=os.path.join(k_config.serverDir,"data","sessions.pdl")
